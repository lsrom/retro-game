...
INSERT INTO public.item_definitions (id, type, kind, name, metal_cost, crystal_cost, deuterium_cost, cost_factor, base_energy, unit_type, capacity, weapons, shield, armor) VALUES (51, 'UNIT', 'GAUSS_CANNON', 'Gauss Cannon', 20000, 15000, 2000, 1, 0, 'DEFENSE', 0, 1100, 200, 35000);
