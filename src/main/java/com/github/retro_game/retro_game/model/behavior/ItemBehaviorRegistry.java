...
public final class ItemBehaviorRegistry {
    ...
    private static Map<String, UnitBehavior> buildUnitBehaviors() {
        ...
        // The recycler upgrades from Combustion Drive to Impulse Drive at level 17,
        // then to Hyperspace Drive at level 15.
        m.put(UnitKind.RECYCLER, new UnitBehavior(
                List.of(
                        new Propulsion(TechnologyKind.COMBUSTION_DRIVE, 0, 2000, 300),
                        new Propulsion(TechnologyKind.IMPULSE_DRIVE, 17, 4000, 300),
                        new Propulsion(TechnologyKind.HYPERSPACE_DRIVE, 15, 6000, 300)
                ),
                rapidFire(UnitKind.ESPIONAGE_PROBE, 5, UnitKind.SOLAR_SATELLITE, 5)));
