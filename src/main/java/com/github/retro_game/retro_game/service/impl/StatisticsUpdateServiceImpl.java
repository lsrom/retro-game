...
public class StatisticsUpdateServiceImpl implements StatisticsUpdateService {
  private static final Logger logger = LoggerFactory.getLogger(StatisticsUpdateServiceImpl.class);
  ...
  // updateStatistics()), so they pick up catalog edits made through the admin panel.
  private final String updateOverallStatisticsSql;

  public StatisticsUpdateServiceImpl(JdbcTemplate jdbcTemplate, StatisticsCache statisticsCache,
